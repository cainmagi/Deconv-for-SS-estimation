...
\begin{figure*}[htbp]
  \centering
  \subfigure[Reconstructed signal for the thenar/hypothenar data.]{\includegraphics[width=0.9\textwidth]{thenar}}
  \subfigure[Reconstructed signal for the volar middle phalanx data.]{\includegraphics[width=0.9\textwidth]{middle_phalanx}}
  \subfigure[Reconstructed signal for the medial plantar surface data.]{\includegraphics[width=0.9\textwidth]{medial_plantar}}
  \subfigure[The solved neural stimuli]{\includegraphics[width=0.9\textwidth]{stimuli} \label{fig:stimuli}}
