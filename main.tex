...
\begin{figure*}[htbp]
  \centering
  \subfigure[]{\includegraphics[width=0.9\textwidth]{middle_phalanx_3} \label{fig:middle_phalanx}}
  \subfigure[]{\includegraphics[width=0.9\textwidth]{medial_plantar_3} \label{fig:medial_plantar}}
  \subfigure[]{\includegraphics[width=0.9\textwidth]{thenar_3} \label{fig:thenar}}
  \subfigure[]{\includegraphics[width=0.9\textwidth]{stimuli_3} \label{fig:stimuli}}
